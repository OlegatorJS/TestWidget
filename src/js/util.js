var util = {
    ...
    parseMonth: function(month) { //TODO: Prohibits change when val[0] returns not completed month i.e. 'Septembe'
      if(isNaN(month)) {
    ...
    template:   '<div class="datepickerbody">'+
                    '<div class="head">'+
                        ...
                        '<div class="display">September 2014</div>'+
                ...
                '</div>',
    secretTemplate: '<span><span class="button-show"><div class="icon-1"><div class="icon-2"></div></div></span></span>',
